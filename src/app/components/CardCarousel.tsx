      ...
      >
        <div className="group relative flex h-full w-full select-none items-center justify-center rounded-lg font-light border cursor-{}">
          ...
          <div
            ...
            className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-xl border border-slate-800 bg-gradient-to-r from-yellow-100 to-yellow-50 px-8 py-16 shadow-2xl"
          >
            ...
            />
            <div className="relative flex flex-col justify-around items-center h-full">{children}</div>
          </div>
        </div>
      </div>
    </>
